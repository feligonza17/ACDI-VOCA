...
acdi_imr$Municipio_imr[acdi_imr$Municipio_imr=="TURBO"] <- "Turbo"
acdi_imr$Municipio_imr[acdi_imr$Municipio_imr=="BOGOTA, D.C."] <- "Bogotá, D.c."
acdi_imr$Municipio_imr[acdi_imr$Municipio_imr=="CARTAGENA"] <- "Cartagena De Indias"
acdi_imr$Municipio_imr[acdi_imr$Municipio_imr=="SANTA MARTA"] <- "Santa Marta"
acdi_imr$Municipio_imr[acdi_imr$Municipio_imr=="CALI"] <- "Cali"
acdi_imr$Municipio_imr[acdi_imr$Municipio_imr=="VISTAHERMOSA"] <- "Vistahermosa"
acdi_imr$Municipio_imr[acdi_imr$Municipio_imr=="ARAUCA"] <- "Arauca"
acdi_imr$Municipio_imr[acdi_imr$Municipio_imr=="ARAUQUITA"] <- "Arauquita"
acdi_imr$Municipio_imr[acdi_imr$Municipio_imr=="SAN CARLOS"] <- "San Carlos"
acdi_imr$Municipio_imr[acdi_imr$Municipio_imr=="QUIBDO"] <- "Quibdó"
acdi_imr$Municipio_imr[acdi_imr$Municipio_imr=="APARTADO"] <- "Apartadó"
acdi_imr$Municipio_imr[acdi_imr$Municipio_imr=="BOJAYA"] <- "Bojayá"
acdi_imr$Municipio_imr[acdi_imr$Municipio_imr=="PUERTO RICO"] <- "Puerto Rico"
acdi_imr$Municipio_imr[acdi_imr$Municipio_imr=="CIENAGA"] <- "Ciénaga"
acdi_imr$Municipio_imr[acdi_imr$Municipio_imr=="CHAPARRAL"] <- "Chaparral"
acdi_imr$Municipio_imr[acdi_imr$Municipio_imr=="CARTAGENA DEL CHAIRA"] <- "Cartagena Del Chairá"
acdi_imr$Municipio_imr[acdi_imr$Municipio_imr=="RIOBLANCO"] <- "Rioblanco"
acdi_imr$Municipio_imr[acdi_imr$Municipio_imr=="FLORENCIA"] <- "Florencia"
acdi_imr$Municipio_imr[acdi_imr$Municipio_imr=="BUENAVENTURA"] <- "Buenaventura"
acdi_imr$Municipio_imr[acdi_imr$Municipio_imr=="MESETAS"] <- "Mesetas"
acdi_imr$Municipio_imr[acdi_imr$Municipio_imr=="SAN VICENTE DEL CAGUAN"] <- "San Vicente Del Caguán"
...
Finalmente, vamos a pegar esta base de datos (el CEDE general) con el resto porque esta presenta la informacion mas general de todos los municipios (ano, pib, poblacion, etc.)
